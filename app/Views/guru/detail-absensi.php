                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"
                                                    colspan="<?= count(getTrAbsensiKelas($id_kelas, $id_semester)) ?>">
                                                    Pertemuan <button class="btn btn-primary btn-add"><i
                                                            class="las la-plus"></i></button></td>
                                                <td colspan="4">Jumlah</td>
                                            </tr>
                                            <tr>
                                                <?php foreach(getTrAbsensiKelas($id_kelas, $id_semester) as $key => $value){ ?>
                                                <td><?= ++$key; ?></td>
                                                <?php } ?>
                                                <td>H</td>
                                                <td>I</td>
                                            ...
                                            <tr>
                                                ...
                                                <?php foreach(getTrAbsensiKelas($id_kelas, $id_semester) as $key2 => $value2){ ?>
                                        ...
                                        <input type="hidden" name="jumlah_absensi" value="<?= count(getTrAbsensiKelas($id_kelas, $id_semester)) ?>">
