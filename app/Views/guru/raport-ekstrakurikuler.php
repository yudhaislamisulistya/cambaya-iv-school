                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="pramuka" id="pramuka"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['pramuka'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td>
                                                <input type="text" name="tari" id="tari"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['tari'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            ...
                                            <td>
                                                <input type="text" name="sanggar_mewarnai_dan_menggambar" id="sanggar_mewarnai_dan_menggambar"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="quran_club" id="quran_club"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['quran_club'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>5</td>
                                            ...
                                            <td>
                                                <input type="text" name="sains_club" id="sains_club"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['sains_club'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>6</td>
                                            ...
                                            <td>
                                                <input type="text" name="english_club" id="english_club"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['english_club'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>7</td>
                                            ...
                                            <td>
                                                <input type="text" name="sepak_bola" id="sepak_bola"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['sepak_bola'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>8</td>
                                            ...
                                            <td>
                                                <input type="text" name="tenis_meja" id="tenis_meja"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['tenis_meja'] ?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>9</td>
                                            ...
                                            <td>
                                                <input type="text" name="pmr_dan_dokcil" id="pmr_dan_dokcil"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['pmr_dan_dokcil'] ?>">
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
