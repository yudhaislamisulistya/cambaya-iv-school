                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="datatable" class="table data-table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= route_to('absensi_admin_detail', $value->id_mata_pelajaran, $value->id_kelas, getSemesterAktif()['id_semester']) ?>"
