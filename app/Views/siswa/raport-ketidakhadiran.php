                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="sakit" id="sakit"
                                                    class="form-control" readonly value="<?= $data['sakit'] ?>" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Izin</td>
                                            <td>
                                                <input type="text" name="izin" id="izin"
                                                    class="form-control" readonly value="<?= $data['izin'] ?>" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Alpha</td>
                                            <td>
                                                <input type="text" name="alpha" id="alpha"
                                                    class="form-control" readonly value="<?= $data['alpha'] ?>" readonly>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
