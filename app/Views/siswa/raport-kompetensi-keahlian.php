                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="sikap_spiritual" id="sikap_spiritual"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['sikap_spiritual'] ?>" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            ...
                                            <td>
                                                <input type="text" name="sikap_sosial" id="sikap_sosial"
                                                    class="form-control" placeholder="Keterangan" value="<?= $data['sikap_sosial'] ?>" readonly>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
