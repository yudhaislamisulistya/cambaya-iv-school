                                ...
                                <tbody>
                                    <?php foreach ($data as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= route_to('jadwal_mata_pelajaran_siswa_detail', $value->id_kelas, $value->id_semester) ?>" class="btn btn-warning btn-sm"><i class="las la-calendar"></i>Detail Jadwal</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
